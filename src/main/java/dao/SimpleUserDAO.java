...
public class SimpleUserDAO {
	...
	// sets.
	public static final String SIMPLE_USER_TABLE = "simple_user";
	public static final String SIMPLE_USER_ID = "simple_user_ID";
	public static final String FIRST_NAME = "first_name";
	public static final String LAST_NAME = "last_name";
	public static final String LOCATION = "location";
	public static final String USERNAME = "simple_username";
	public static final String PASSWORD = "password";
	public static final String EMAIL = "email";
	public static final String ACTIVE_ACCOUNT = "active_account";
	public static final String PHOTO_NAME = "simple_photo";
