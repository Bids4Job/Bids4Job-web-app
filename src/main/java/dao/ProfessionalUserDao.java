...
public class ProfessionalUserDao {
	...
	String query = "UPDATE " + PROFFESIONAL_USER_TABLE + " SET " + FIRST_NAME + "= ?, " + LAST_NAME + "= ?, "
		+ LOCATION + "= ?, " + PROFESSION + "= ?, " + USERNAME + "= ?, " + PASSWORD + "= ?, " + EMAIL + "= ?, "
		+ ACTIVE + "= ? WHERE " + PRO_USER_ID + "=?";
    ...
    public ProfessionalUser create(ProfessionalUser professionalUser)
	    throws SQLException, IllegalAccessException, ClassNotFoundException, InstantiationException {
	String query = "INSERT INTO " + PROFFESIONAL_USER_TABLE + "(" + FIRST_NAME + ", " + LAST_NAME + ", " + LOCATION
		+ ", " + PROFESSION + ", " + USERNAME + ", " + PASSWORD + ", " + EMAIL + ", " + ACTIVE + ", "
		+ PHOTO_NAME + ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	this.prepareResources();
	;
	try {
     ...
     * @throws InstantiationException
     */
    public List<ProfessionalUser> fiandAll()
	    throws SQLException, IllegalAccessException, ClassNotFoundException, InstantiationException {
	List<ProfessionalUser> professionalUsers = new ArrayList<>();
    ...
    public ProfessionalUser findByEmail(String email)
    ...
    /**
     * Utility method that takes a result set and returns a ProfessionalUser
     * object.
     * 
     * @param resultSet
     * @return
	...
	return new ProfessionalUser().setProUSerId(resultSet.getInt(PRO_USER_ID))
		.setFirstName(resultSet.getString(FIRST_NAME)).setLastName(resultSet.getString(LAST_NAME))
		.setLocation(resultSet.getString(LOCATION)).setProfession(resultSet.getString(PROFESSION))
		.setUsername(resultSet.getString(USERNAME)).setPassword(resultSet.getString(PASSWORD))
		.setEmail(resultSet.getString(EMAIL)).setActive(resultSet.getBoolean(ACTIVE))
