	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(contract.toString() + " updated: "
					+ contractDAO.update(contract.setBidID(3).setProRating(2.3)) + "\nto " + contract.toString());
			// findOne
			...
			System.out.println("\nfindRatingByProUserID()");
			System.out.println("Average rating of pro user #11: " + contractDAO.findRatingAndVotesByProUserID(11));
			// findRatingByProUserID
			System.out.println("\nfindRatingByProUserID()");
			System.out.println("Average rating of pro user #3: " + contractDAO.findRatingAndVotesByProUserID(3));

			// findRatingByProUserID
			System.out.println("\nfindRatingByProUserID()");
			System.out.println("Average rating of pro user #2: " + contractDAO.findRatingAndVotesByProUserID(14));
			crs = contractDAO.findRatingAndVotesByProUserID(50);
			...
			crs = contractDAO.findDetailsByProfessionalUserID(1);
			if (!crs.isBeforeFirst()) {
				System.out.println("No data");
			} else {
				while (crs.next()) {
