...
public class ContractTester {
	...
	public static void main(String[] args) {
		// Contract 1
		Contract contract1 = new Contract(1, 5, 18, 4.3, new Timestamp(System.currentTimeMillis()));
		...
		System.out.println("Pro Rating: " + contract1.getProRating());
		System.out.println("ContractTime: " + contract1.getContractTime());
		// Contract 2
		Contract contract2 = new Contract().setTaskID(20).setBidID(13).setContractID(10).setProRating(4.2)
