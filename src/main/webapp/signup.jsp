			...
			<div class="tab-content">
				<div id="Individual" class="tab-pane fade in active">
					...
					<form class="form-horizontal" method="POST"
						enctype="multipart/form-data" action="register_simple"
						class="form-signup">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="uname" ng-model="uname"
									class="form-control" id="username" placeholder="Your user name"
									required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="firstname" class="form-control"
									id="fname" placeholder="Your first name" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="surname" class="form-control"
									id="sname" placeholder="Your surname" required>
							</div>
						</div>
          ...
          -->
						...
						<div class="form-group">
							<label for="profile-image" class="col-sm-2 control-label">Profile
								Image</label>
							<div class="col-sm-6">
								<input type="file" name="simple-image" class="form-control"
