  ...
  <!--Navbar start-->
   ...
   <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid navbar-transp">
        <div class="navbar-header"><!--start collapsed navbar-->
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide mod-img" src="images/1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide mod-img" src="images/2.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Ask us about your need!</h1>
              <p>Have questions about a specific problem and would like to get an answer?</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Contact Us</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="third-slide mod-img" src="images/3.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Are you a professional?</h1>
              <p>Are you a professional interested in boosting your business? Let us show you how we can help you!</p>
