...
<%@ include file="ProfessionalUserHeader.html" %>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  <form action = "/Project/ProfessionalUserCreate" method= "POST">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <p>Please type the professional user id and any of the fields you want to update.</p>
                  <form action = "/Project/ProfessionalUserUpdate" method= "POST">
                  	<div class="input-group input-group-lg">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  ...
                  <form action = "/Project/ProfessionalUserRemove" method= "POST">
                    <div class="input-group input-group-lg">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  ...
                  <form action = "/Project/ProfessionalUserFindOne" method= "GET">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon" id="basic-addon1">Professional User id: </span>
                      <input type="number" class="form-control" placeholder="type here" aria-describedby="basic-addon1" name="proUserId">
                    </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  ...
                  <form action = "/Project/ProfessionalUserFindFromLocation" method= "GET">
                    <div class="input-group input-group-lg">
          ...
          <section>
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  <form action = "/Project/ProfessionalUserFindAll" method= "GET">
                    <br>
