						...
						<div class="panel-heading" role="tab" id="headingThree">
							<h4 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse"
									...
									aria-expanded="false" aria-controls="collapseThree"> Task
									#3 by simple_user3 </a>
							</h4>
						</div>
						...
						<div class="panel-heading" role="tab" id="headingSeven">
							<h4 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse"
									...
									aria-expanded="false" aria-controls="collapseSeven"> Task
									#7 by simple_user7 </a>
							</h4>
						</div>
						...
						<div class="panel-heading" role="tab" id="headingEight">
							<h4 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse"
									...
									aria-expanded="false" aria-controls="collapseEight"> Task
									#8 by simple_user8 </a>
							</h4>
						</div>
